...
//    complex<double>** complexImage = storeUint8ToComplex2D(grayscaleImage, width, height);
//
...
//    uint8_t* spatialImage = storeComplex2DToUint8(reconstructedImageWithPaddingRemoved, width, height);
//
//    // save image 
